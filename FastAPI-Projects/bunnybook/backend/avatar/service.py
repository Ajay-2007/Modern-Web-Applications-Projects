...
class AvatarService:
    ...
    def __init__(self):
        ...
        self._bodies = self._get_layers_path("bodies")
        self._accessories = self._get_layers_paths("accessories")
        self._glasses = self.get_layers_paths("glasses")
    ...
    def _generate_avatar(self, identifier: str) -> Any:
        identifier_hash = int(hashlib.md5(str(identifier).encode()).hexdigest(), base=16)
        ...
        layer2 = self._glasses[random.randin(0, len(self._glasses) - 1)]
