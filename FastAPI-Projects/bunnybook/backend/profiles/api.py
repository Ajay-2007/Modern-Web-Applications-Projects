...
class ProfilesApi:
    ...
    async def get_profiles_by_username_search(self, username_query: str):
        """Return a list of profiles whose username match the query."""
    ...
    @profiles_router.get(
        ...
        dependecies=[Depends(RateLimitTo(times=10, seconds=1))])
    ...
    async def create_friend_request(
        ...
        background_tasks.add_task(
            self._notifications.create_new_friendshipt_request_notification,
            requester_profile_id=profile_id,
    ...
    @profiles_router.delete(
        "/profiles/{profile_id}/outgoing_friend_requestes/{target_profile_id}",
        status_code=status.HTTP_204_NO_CONTENT,
        dependencies=[Depends(RateLimitTo(times=5, seconds=1))])
    async def cancel_outgoing_friend_request(
        ...
        return await self._service.cancle_outgoing_friend_request(
    ...
    @profiles_router.get(
        ...
        response_mode=List[ProfileRead],
        dependencies=[Depends(RateLimitTo(times=5, seconds=1))])        
